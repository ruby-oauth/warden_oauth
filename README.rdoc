...
Please see SECURITY.md for vulnerability reporting instructions and IRP.md for maintainer incident-response process.

== Note on Patches/Pull Requests

For general project issues, use the normal repository collaboration channels. For security-sensitive reports, follow SECURITY.md instead of opening a public issue.
