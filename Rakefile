...
# warden_oauth Rakefile v7.0.0 - 2026-07-14
...
# rake install                                # Build and install warden_oauth-1.0.0.gem in...
# rake install:local                          # Build and install warden_oauth-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template warden_oauth against itse...
