...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/warden_oauth/version.rb", mod) }::WardenOauth::Version::VERSION
  else
...
Gem::Specification.new do |spec|
  ...
  # The 'git' gem is optional; warden_oauth falls back to shelling out to `git` if it is not present.
